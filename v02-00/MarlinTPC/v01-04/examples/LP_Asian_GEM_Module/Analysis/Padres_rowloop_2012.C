...
//--Set Style
 ...
 // Int_t kRun[] = { 19868, 19867, 19866, 19865, 19869, 19864, 19870, 19863, 19862, 19861, 19871, 19860, 19872, 19873, 19874}; // B=1T,with gate(not recomend)
  ...
  //Int_t kRun[] = { 19743, 19742, 19741, 19740, 19739, 19738,19737, 19736, 19735, 19734, 19733, 19732}; // B=1T,with gate(not recomend) phi=10
     ...
     ofstream outf("result_2012/Cd_by_Row_gate_module3_18564_withcut.dat");
     ofstream outf2("result_2012/sigmaPR0_by_Row_gate_module3_18564_withcut.dat");
  // ---------------
  // Loop over rows
  // ---------------
#if 1
  ...
  stringstream ofile;
  ofile << "result_2012/PadRes_Module" << module << "_Row" << row << "_withgate18609_withcut.pdf"<< ends;
