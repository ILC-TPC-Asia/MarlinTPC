...
void Residual(Int_t module = 3, Int_t row = 16)
{
//--Set Style
  // Axis
 ...
 //ofstream outf("result_module3/sigamx2_sigmaPR2_by_Row_gate_module3.dat");
 ofstream outf("result_module3/Padres_field_module3_mean.dat");
  ...
  titlestr << "Residual(Module" <<module << "_Row" << row << ")" << ends;
